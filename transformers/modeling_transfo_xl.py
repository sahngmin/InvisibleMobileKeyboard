...
TRANSFO_XL_START_DOCSTRING = r"""    The Transformer-XL model was proposed in
    `Transformer-XL: Attentive Language checkpoints Beyond a Fixed-Length Context`_
    ...
    .. _`Transformer-XL: Attentive Language checkpoints Beyond a Fixed-Length Context`:
...
class TransfoXLModel(TransfoXLPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        if self.attn_type == 0:  # default attention
            ...
            raise NotImplementedError  # Removed these to avoid maintaining dead code - They are not used in our pretrained checkpoints
