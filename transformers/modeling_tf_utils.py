    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        Parameters:
            pretrained_model_name_or_path: either:
                ...
                - a path or url to a `PyTorch state_dict save file` (e.g. `./pt_model/pytorch_model.bin`). In this case, ``from_pt`` should be set to True and a configuration object should be provided as ``config`` argument. This loading path is slower than converting the PyTorch checkpoints in a TensorFlow model using the provided conversion scripts and loading the TensorFlow model afterwards.
        ...
        if pretrained_model_name_or_path is not None:
            if pretrained_model_name_or_path in cls.pretrained_model_archive_map:
                ...
                if from_pt:
                    raise EnvironmentError(
                        "Loading a TF model from a PyTorch checkpoints is not supported when using a model identifier name."
                    )
        ...
        try:
            ...
            raise OSError(
                ...
                "If you tried to load a TF 2.0 model from a PyTorch checkpoints, please set from_pt=True. "
            )
