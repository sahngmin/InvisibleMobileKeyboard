...
class PretrainedConfig(object):
    r""" Base class for all configuration classes.
        ...
        Parameters:
            ``finetuning_task``: string, default `None`. Name of the task used to fine-tune the model. This can be used when converting from an original (TensorFlow or PyTorch) checkpoints.
