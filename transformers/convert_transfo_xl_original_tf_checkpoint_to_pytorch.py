...
"""Convert Transformer XL checkpoints and datasets."""
...
def convert_transfo_xl_checkpoint_to_pytorch(
    ...
    if tf_checkpoint_path:
        ...
        print("Converting Transformer XL checkpoints from {} with config at {}".format(tf_path, config_path))
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="",
        type=str,
        help="An optional path to a TensorFlow checkpoints path to be converted.",
    )
    parser.add_argument(
