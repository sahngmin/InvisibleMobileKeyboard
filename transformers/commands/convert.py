...
def convert_command_factory(args: Namespace):
    """
    Factory function used to convert a model TF 1.0 checkpoints in a PyTorch checkpoints.
    :return: ServeCommand
    """
...
class ConvertCommand(BaseTransformersCLICommand):
    ...
    def register_subcommand(parser: ArgumentParser):
        ...
        train_parser.add_argument(
            "--tf_checkpoint", type=str, required=True, help="TensorFlow checkpoints path or folder."
        )
        train_parser.add_argument(
