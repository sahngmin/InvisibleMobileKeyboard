...
def convert_pt_checkpoint_to_tf(
    ...
    # Load weights from tf checkpoints
    ...
    # Load PyTorch checkpoints in tf2 model:
        ...
        for i, (model_shortcut_name, config_shortcut_name) in enumerate(
            ...
            if "-squad" in model_shortcut_name or "-mrpc" in model_shortcut_name or "-mnli" in model_shortcut_name:
                if not only_convert_finetuned_models:
                    print("    Skipping finetuned checkpoints {}".format(model_shortcut_name))
                    continue
                model_type = model_shortcut_name
            elif only_convert_finetuned_models:
                print("    Skipping not finetuned checkpoints {}".format(model_shortcut_name))
                continue
            print(
                "    Converting checkpoints {}/{}: {} - model_type {}".format(
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default=None,
        type=str,
        help="Path to the PyTorch checkpoints path or shortcut name to download from AWS. "
    ...
    parser.add_argument(
        "--use_cached_models",
        action="store_true",
        help="Use cached models if possible instead of updating to latest checkpoints versions.",
    )
    parser.add_argument(
        "--remove_cached_files",
        action="store_true",
